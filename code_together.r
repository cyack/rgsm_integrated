...
#
par(mar=c(4,5,1,1))
plot(c(5:7000)*0.0283,q2hab(c(5:7000),t3[6,])/min(q2hab(c(5:7000),t3[6,])),axes=FALSE,lwd=3,ylab="",xlab="",type="l",col=rgb(0,0,0,.6),log="xy",ylim=c(1,1000),xlim=c(0.1,200))
points(c(5:7000)*0.0283,q2hab(c(5:7000),t3[1,])/min(q2hab(c(5:7000),t3[1,])),type="l",col=rgb(1,0,0,.4),lwd=2)
points(c(5:7000)*0.0283,q2hab(c(5:7000),t3[2,])/min(q2hab(c(5:7000),t3[2,])),type="l",col=rgb(0,1,0,.4),lwd=2)
points(c(5:7000)*0.0283,q2hab(c(5:7000),t3[3,])/min(q2hab(c(5:7000),t3[3,])),type="l",col=rgb(0,0,1,.4),lwd=2)
points(c(5:7000)*0.0283,q2hab(c(5:7000),t3[4,])/min(q2hab(c(5:7000),t3[4,])),type="l",col=rgb(0,1,1,.4),lwd=2)	
points(c(5:7000)*0.0283,q2hab(c(5:7000),t3[5,])/min(q2hab(c(5:7000),t3[5,])),type="l",col=rgb(1,0,1,.4),lwd=2)
mtext("Relative Amount of Larval habitat",2,2.5,cex=0.7)
mtext("Discharge (cms)",1,2,cex=0.7)
axis(2,at=c(1,10,100,1000),labels=c("1","10","10^2","10^3"),las=T,pos=0.1)
axis(1,c(0.1,1,10,100),pos=1)
axis(1,c(0,300),c("",""),tck=FALSE,pos=1)
text(.018,1400,"B)",xpd=T)
#
plot(t2*0.0283,pch=19,col=c(rgb(1,0,0,.4),rgb(0,1,0,.4),rgb(0,0,1,.4),rgb(0,1,1,.4),rgb(1,0,1,.4)),xlab="",ylab="",ylim=c(0,30),xlim=c(0.5,5.5),axes=FALSE)
segments(c(1:6),(t2+t2se)*0.0283,c(1:6),(t2-t2se)*0.0283,col=c(rgb(1,0,0,.4),rgb(0,1,0,.4),rgb(0,0,1,.4),rgb(0,1,1,.4),rgb(1,0,1,.4)))
axis(2,pos=0.5,las=T)
axis(1,at=c(0.5,1:5,7),labels=c("",1:5,""),pos=0)
points(3,t2[3]*0.0283,col=rgb(0,0,0,.6),pch=19)
mtext("Discharge that cues spawning (cms)",2,3,cex=0.7)
...
par(mfrow=c(2,2))
par(mar=c(3,4,2,2))
plot(1,col="white",xlim=c(.028,30),ylim=c(0,350),xlab="",ylab="",axes=FALSE,log="x")
mtext("Wetted area per site (x 100 m^2)",2,2.25,cex=0.8)
mtext("Discharge(cms)",1,1.75,cex=0.8)
axis(1,c(0.03,.3,3,30),pos=0)
axis(2,c(0,100,200,300),las=T,pos=.028)
polygon(c(1:1000,1000:1)*.0283,c(apply(ppool[1:1000,],1,q025),apply(ppool[1000:1,],1,q975))*4000,col=rgb(0,0,1,.4),border=NA)
polygon(c(1:1000,1000:1)*.0283,c(apply(thab[1:1000,1,],1,q025),apply(thab[1000:1,1,],1,q975))/100,col="orange",border="orange")
polygon(c(1:1000,1000:1)*.0283,c(apply(thab[1:1000,2,],1,q025),apply(thab[1000:1,2,],1,q975))/100,col="red",border="red")
polygon(c(1:1000,1000:1)*.0283,c(apply(thab[1:1000,3,],1,q025),apply(thab[1000:1,3,],1,q975))/100,col="purple",border="purple")
legend(1*.0283,375,c("% Pool (2nd y-axis)","San Acacia"),fill=c(rgb(0,0,1,.4),col="orange"),bty="n",border=NA)
legend(50*.0283,375,c("Isleta","Angostura"),fill=c("red","purple"),bty="n",border=NA)
axis(4,at=seq(0,300,100),labels=seq(0,7.5,2.5),las=T,pos=30,col="blue",col.axis="blue")
mtext("% pool",4,1.5,col="blue",las=FALSE,cex=0.7)
text(.22*.0283,390,"A)",xpd=T)
## 2nd panel
plot(1,col="white",xlim=c(.028,30),ylim=c(0,15),xlab="",ylab="",axes=FALSE,log="x")
polygon(c(1:1000,1000:1)*.0283,c(apply(ta0[1:1000,],1,q025),apply(ta0[1000:1,],1,q975)),col=rgb(0,1,0,.5),border=NA)
polygon(c(1:1000,1000:1)*.0283,c(apply(ta1[1:1000,],1,q025),apply(ta1[1000:1,],1,q975)),col=rgb(1,0,1,.5),border=NA)
legend(5*.0283,15,c("Age-0","Age-1+"),fill=c(rgb(0,1,0,0.5),rgb(1,0,1,.5)),bty="n",border=NA)
mtext("Density in pools relative to runs/riffles",2,1.5,cex=0.8)
mtext("Discharge(cms)",1,1.75,cex=0.8)
axis(1,c(0.03,.3,3,30),pos=0)
axis(2,las=T,pos=.028)
segments(.028,1,30,1,lty=2)
text(.31*.0283,16.5,"B)",xpd=T)
# 3rd panel
plot(1,col="white",xlim=c(.028,30),ylim=c(0.1,100),xlab="",ylab="",axes=FALSE,log="xy")
polygon(c(1:1000,1000:1)*.0283,c(apply(cpe100[1:1000,],1,q025),apply(cpe100[1000:1,],1,q975)),col=rgb(0,0,0,.4),border=NA)
mtext("Catch per 100 m^2",2,2.25,cex=0.8)
mtext("Discharge(cms)",1,1.75,cex=0.8)
axis(1,c(0.03,.3,3,30),pos=0.1)
axis(2,c(0.1,1,10,100),las=T,pos=.028)
text(.22*.0283,210,"C)",xpd=T)
# 4th panel
plot(c(7.5,10,15,30,60,90,120)/30*mean(cpe100[500,]),ylim=c(0,4),xlim=c(0.5,7.5),xlab="",ylab="",axes=FALSE,col="white")
mtext("Catch per 100 m^2",2,1.5,cex=0.8)
mtext("Overall abundance (x 1000)",1,1.75,cex=0.8)
for (i in 1:9){	
...
par(mfrow=c(2,2))
par(mar=c(3,4,1,1))
plot(.0283*1000*c(simpflow[,1],simpflow_out[,1]),c(preds2[,1],preds_out[,1]),pch=c(rep(19,17),8,8),col=colz,axes=FALSE,ylab="",xlab="",xlim=c(0,125),ylim=c(0,1.3))
axis(1,seq(0,125,25),pos=0)
axis(2,seq(0,1.25,0.25),las=T,pos=0)
mtext("Mean May and June discharge (cms)",1,2,cex=0.85)
mtext("Larval CC index",2,2.5,cex=0.85)
text(-1300*.0283,1.35,"A)",xpd=T)
#
...
text(0.7,1.3,"B)",xpd=T)
##
plot(c(32:155),.0283*sQ[32:155,16],type="l",axes=FALSE,ylab="",xlab="",ylim=c(0,170),xlim=c(32,155),col=colz[16])
points(c(32:155),.0283*sQ_out[32:155,1],type="l",col=colz[18])
axis(2,las=T,pos=32)
axis(1,c(-10,32,62,93,124,155),c("","Apr-1","May-1","Jun-1","Jul-1","Aug-1"),pos=0)
mtext("Mean daily flow (cms)",2,2.5,cex=0.85)
mtext("Month-Day",1,2,cex=0.85)
text(1,6600*.0283,"C)",xpd=T)
# 
...
legend(0.08,1,c("12 mcm added May 16th to June 9","12 mcm added near optimally"),pch=19,col=c(rgb(0,0,1,.4),"darkblue"),bty="n",cex=CX/0.7)
legend(0.62,1,c("37 mcm added May 16th to June 9","37 mcm added near optimally"),pch=19,col=c(rgb(0,1,0,.4),"darkgreen"),bty="n",cex=CX/0.7)
#
...
plot(.0283*sQ[1:155,14],type="l",axes=FALSE,ylab="",xlab="",ylim=c(0,115),xlim=c(1,155))
polygon(c(77:101,101:77),.0283*c(sQ[77:101,14],sQ[101:77,14]+5042/25),col=rgb(0,0,1,.4),border=NA)
polygon(c(77:101,101:77),.0283*c(sQ[77:101,14]+5042/25,sQ[101:77,14]+3*5042/25),col=rgb(0,1,0,.4),border=NA)
polygon(c(1:155,155:1),.0283*c(sQ[1:155,14],add30[155:1,14]),col="forestgreen",border=NA)
polygon(c(1:155,155:1),.0283*c(sQ[1:155,14],add10[155:1,14]),col="darkblue",border=NA)
axis(2,c(0,50,100),las=T,pos=1,cex.axis=CX/0.7,hadj=0.7,tck=-0.03)
...
mtext("Mean daily flow (cms)",2,1.5,cex=CX)
mtext("Month-Day",1,1,cex=CX)
text(4,.0283*4000,"Larval CC index values",cex=CX/0.7,adj=0)
text(4,.0283*3500,"baseline (2015): 0.67",cex=CX/0.7,adj=0)
text(4,.0283*3000,"12 mcm (5/16-6/19): 0.71",cex=CX/0.7,adj=0,col=rgb(0,0,1,.4))
text(4,.0283*2500,"12 mcm (near optimal): 0.91",cex=CX/0.7,adj=0,col="darkblue")
text(4,.0283*2000,"37 mcm (5/16-6/19): 0.74",cex=CX/0.7,adj=0,col=rgb(0,1,0,.4))
text(4,.0283*1500,"37 mcm (near optimal): 0.95",cex=CX/0.7,adj=0,col="forestgreen")
text(-13,.0283*4200,"E)",xpd=T)
#
plot(.0283*sQ[1:155,9],type="l",axes=FALSE,ylab="",xlab="",ylim=c(0,115),xlim=c(1,155))
polygon(c(77:101,101:77),.0283*c(sQ[77:101,9],sQ[101:77,9]+5042/25),col=rgb(0,0,1,.4),border=NA)
polygon(c(77:101,101:77),.0283*c(sQ[77:101,9]+5042/25,sQ[101:77,9]+3*5042/25),col=rgb(0,1,0,.4),border=NA)
polygon(c(1:155,155:1),.0283*c(sQ[1:155,9],add30[155:1,9]),col="forestgreen",border=NA)
polygon(c(1:155,155:1),.0283*c(sQ[1:155,9],add10[155:1,9]),col="darkblue",border=NA)
axis(2,c(0,50,100),las=T,pos=1,cex.axis=CX/0.7,hadj=0.7,tck=-0.03)
axis(1,c(1,32,62,93,124,155),c("Mar-1","Apr-1","May-1","Jun-1","Jul-1","Aug-1"),pos=0,cex.axis=CX/0.7,padj=-.5,tck=-0.03)
axis(1,c(0,160),c("",""),pos=0,cex.axis=CX/0.7,padj=-.5,tck=0)
mtext("Mean daily flow (cms)",2,1.5,cex=CX)
mtext("Month-Day",1,1,cex=CX)
text(110,.0283*4000,"Larval CC index values",cex=CX/0.7,adj=0)
text(110,.0283*3500,"baseline (2010): 0.77",cex=CX/0.7,adj=0)
text(110,.0283*3000,"12 mcm (5/16-6/19): 0.77",cex=CX/0.7,adj=0,col=rgb(0,0,1,.4))
text(110,.0283*2500,"12 mcm (near optimal): 0.79",cex=CX/0.7,adj=0,col="darkblue")
text(110,.0283*2000,"37 mcm (5/16-6/19): 0.77",cex=CX/0.7,adj=0,col=rgb(0,1,0,.4))
text(110,.0283*1500,"37 mcm (near optimal): 0.81",cex=CX/0.7,adj=0,col="forestgreen")
text(-13,.0283*4200,"F)",xpd=T)
...
legend(0.57,1.1,c("Augment Spawners","Restore larval habitat","Increase flows by 12 mcm","Fish rescue","Reduce drying"),col=colorz,pch=16,bty="n",cex=1.2,y.intersp=1.2)
#
